        ...
        >
           ...
           <section>
            <div className="container py-5">
                <h1 className="fs-36 pb-3">EVENTS <span>(8)</span></h1>
                ...
                <div className="flex-3col" >
              {
                UserData.map(  ( users, eventsData )=>(  
                  ...
                  <img className="mob-img" src="/assets/img-01.jpg" alt="title" />
                    <h3 className="title pb-3"> {users.title}</h3>
                    <div className="info pb-3">
                      <div>{users.date}</div>
                      <div  className={users.cltickets}>Tickets Available: <span>{users.tickets}</span></div>
                    </div>
                    <div className="d-flex">
                    <NavLink  className={users.clname} to='/EventBooking' >
                      <FaCalendarPlus className="d-icon" /><span>{users.available}</span>
                    </NavLink>
                    </div>
                  </div>
                </div>
